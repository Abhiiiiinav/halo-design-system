...
- **Mood:** premium, technical, refined, swiss-style, clean
- **Best For:** High-end commerce, detailed data, editorial
- **Local Fonts:** FK Raster (Display), PP Neue Montreal (Body)
- **CSS Variables:** var(--font-display), var(--font-body)
